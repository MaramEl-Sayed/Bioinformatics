...
def dynamicEditDistance(s, t):
    ...
    """ 
        APPROX MATCHING (s, t) -> ldist
        ldist is the Levenshtein distance between the strings 
        s and t.
        For all i and j, dist[i,j] will contain thedistance between 
...
def apply_algorithm(selected):
    ...
    if text == '':
        ...
        result,table ,sumk= Badchars(text,pattern)
